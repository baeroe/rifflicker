  ...
  const handleRecBtn = () => {
    ...
    if (recOn === true) {
      document.getElementById("recBtn").style.boxShadow =
        "0px 2px 4px -1px rgba(0,0,0,0.2) inset,0px 4px 5px 0px rgba(0,0,0,0.14) inset,0px 1px 10px 0px rgba(0,0,0,0.12) inset";
      audioContext === undefined ? setup() : getPitch();
    } else {
      document.getElementById("recBtn").style.boxShadow =
